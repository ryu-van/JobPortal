...
public interface CompanyService {
    ...
    CompanyDetailResponse getDeatailCompanyById(Long companyId);
    CompanyVerificationRequestResponse  createCompanyVerificationRequest(NewCompanyVerificationRequest newCompanyVerificationRequest, List<MultipartFile> documents, MultipartFile logo);
    ...
    CompanyVerificationRequestResponse updateCompanyVerificationRequest(Long companyVerificationRequestId, NewCompanyVerificationRequest newCompanyVerificationRequest, List<MultipartFile> newDocuments, MultipartFile newLogo);
